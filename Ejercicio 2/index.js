...
function parseJsonAndMark(jsonString) {
    var parsed;
    try {
    ...
    return __assign(__assign({}, parsed), { procesado: true });
}
...
function obtenerProductoSimulado() {
...
var json = '{"nombre":"Mouse","precio":25}';
var objetoProcesado = parseJsonAndMark(json);
...
var filtrados = filtrarYOrdenarProductos(lista);
console.log("Filtrados y ordenados:", filtrados);
(function () { return __awaiter(_this, void 0, void 0, function () {
    var producto;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, obtenerProductoSimulado()];
            case 1:
                producto = _a.sent();
